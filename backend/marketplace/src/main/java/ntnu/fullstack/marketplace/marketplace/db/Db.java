/*
sample code from https://github.com/nilstes/NotSoSecureBank/blob/master/src/main/java/db/Db.java
It is not intended to be used in its finel form but is a example.
 */
