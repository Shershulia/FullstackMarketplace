...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            LOGGER.error("An error occurred while trying to filter the request: {}", e.getMessage());
    ...
    public String validateTokenAndGetUserId(final String token) {
        try {
            ...
            LOGGER.error("An error occurred while trying to validate the token: {}", e.getMessage());
            return null;
        }
    }
