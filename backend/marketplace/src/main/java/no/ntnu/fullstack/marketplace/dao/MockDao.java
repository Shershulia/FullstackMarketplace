...
public class MockDao {
    ...
    private static List<UserInfoResponse> users = new ArrayList<UserInfoResponse>() {
        {
            add(new UserInfoResponse("Ole", "Nordmann", "M", 67,"ole1", "password1"));
            add(new UserInfoResponse("Kari", "Grossmann", "F", 53,"kari2", "password2"));
            add(new UserInfoResponse("John", "Smith", "M", null,"john3", "password3"));
        }
    };
