INSERT INTO USERDATA (id, username, email, password, name, lastname, age,permission)
VALUES (1, 'ole1', 'john.doe@example.com', 'Asdf1234', 'John', 'Doe', 30,'normal');
...
INSERT INTO USERDATA (id, username, email, password, name, lastname, age,permission )
VALUES (2, 'admin', 'john.doe@example.com', 'admin', 'John', 'Doe', 30,'admin');
